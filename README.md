...
Automatically updates the device to the latest compatible software, based on the reported `hw_boardname` and `hw_revision`. Note: versions are interpreted as [SemVer](https://semver.org) versions.
